...
export async function createTemplate(title, kategorie, hauptVerteilObjekt = "Zielobjekt") {
...
// PDF-Vorschau der gespeicherten Vorlage rendern. Mit Zielobjekt → echte Daten
