...
// (englische Status-Keys, vollständige Zielobjekt-Objekte gegen undefined-Crashes).
...
function normRecipient(r) {
	return {
		...
		// Domänenfelder (offener_betrag/statuscode) gibt es im Backend (Phase 1) nicht — leere
		// Defaults, damit die UI nicht auf undefined zugreift.
		offener_betrag: r.offener_betrag || "",
...
// Globale Variablenwerte + Pro-Zielobjekt-Overrides speichern.
