...
// Frappe serves apps/mail_merge/mail_merge/public/ under /assets/mail_merge/.
...
const APP_BASES = {
  editor:    "/assets/mail_merge/serienbrief_editor/",
  browser:   "/assets/mail_merge/serienbrief_browser/",
  durchlauf: "/assets/mail_merge/serienbrief_durchlauf/",
};
...
const base = process.env.HV_BASE || (singleApp ? APP_BASES[singleApp] : "/assets/mail_merge/");
