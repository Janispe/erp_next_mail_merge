...
//   apps/mail_merge/mail_merge/public/serienbrief_browser/
// und wird von Frappe unter /assets/mail_merge/serienbrief_browser/ ausgeliefert.
//
...
frappe.pages["serienbrief_browser"].on_page_load = function (wrapper) {
	...
	const src = `/assets/mail_merge/serienbrief_browser/index.html?v=${Date.now()}`;

	const $frame = $(
		`<iframe class="mail-merge-browser-frame" src="${src}" title="Serienbrief Vorlagen-Browser"></iframe>`
	).css({
		width: "100%",
		border: "none",
		display: "block",
