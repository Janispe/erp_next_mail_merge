...
//   apps/mail_merge/mail_merge/public/serienbrief_editor/
// und wird von Frappe unter /assets/mail_merge/serienbrief_editor/ ausgeliefert.
//
...
const HV_SB = "mail_merge.mail_merge.doctype.serienbrief_vorlage.serienbrief_vorlage.";
const RPC_ACTIONS = {
	...
	editor_footer: HV_SB + "render_editor_footer_html",
...
function buildEditorSrc(template) {
	let s = `/assets/mail_merge/serienbrief_editor/index.html?v=${Date.now()}`;
...
function _hideEditorPageHead(wrapper) {
	...
	$wrapper.addClass("mail-merge-editor-full-height");
...
frappe.pages["serienbrief_editor"].on_page_load = function (wrapper) {
	...
	const $frame = $(
		`<iframe class="mail-merge-editor-frame" src="${src}" title="Serienbrief Editor"></iframe>`
	).css({
		width: "100%",
		border: "none",
		display: "block",
