(() => {
	...
	const api = (window.mail_merge.serienbrief_quill_placeholders =
		window.mail_merge.serienbrief_quill_placeholders || {});

	const STYLE_ID = "mail-merge-quill-placeholder-styles";
