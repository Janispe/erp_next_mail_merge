(() => {
	window.mail_merge = window.mail_merge || {};

	const api = (window.mail_merge.serienbrief_placeholder_picker =
		window.mail_merge.serienbrief_placeholder_picker || {});

	const ensure_tree_styles = () => {
		if (document.getElementById("mail-merge-placeholder-picker-styles")) return;
		const style = document.createElement("style");
		style.id = "mail-merge-placeholder-picker-styles";
		style.textContent = `
